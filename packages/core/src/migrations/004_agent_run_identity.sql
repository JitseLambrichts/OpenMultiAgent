-- Older builds could correlate two runs to the same native identity. Preserve
-- the earliest claim and mark later claims uncorrelated so they can be safely
-- rediscovered instead of blocking the upgrade.
UPDATE agent_run
